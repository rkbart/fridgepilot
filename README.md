...
- **Grocery lists** — create lists and manage items with full CRUD (quantity, unit dropdown, status check-off), plus one-click add missing ingredients from recipes
